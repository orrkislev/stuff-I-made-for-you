...
async function setup() {
    ...
    // createCone(250, 30, 0).setColor('cornflowerblue').setSpeed(.3)
    // createCone(160, 80, 0).setColor('lightblue').setSpeed(.3).translate(0, 20)
    // createCone(120, 100, 0).setColor('cornflowerblue').setSpeed(.3).translate(0, 40)
    // createCone(80, 120, 0).setColor('lightblue').setSpeed(.3).translate(0, 60)
    // createCone(40, 140, 0).setColor('cornflowerblue').setSpeed(.3).translate(0, 80)

    // createSphere(100).setColor('seagreen').setSpeed(.3).translate(0, 160)
    // createSphere(250).setColor('orange').setSpeed(.3).translate(0, 400)
    ...
    createSphere(100).setColor('white')
