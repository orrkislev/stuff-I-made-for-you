...
colors = ['#ae3273', '#251e5b']
backgroundColor = '#a5bf8a'
networkLength = 20
hexGrid = false
maxGridSize = 8
maxVisits = 0
...
function setConnectionColor(c1, c2) {
    const clr1 = dist(mouseX, mouseY, c1.pos.x, c1.pos.y) < c1.radius ? 'white' : c1.color
    const clr2 = dist(mouseX, mouseY, c2.pos.x, c2.pos.y) < c2.radius ? 'white' : c2.color
